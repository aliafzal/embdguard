...
# Quick train
train(model, optimizer, train_small, n_items,
...
results, poisoned, model, optimizer = run_dlattack(
    model, optimizer, train_small, test_small, n_users, n_items,
...
# Detection
flagged = detect_fake_users(poisoned, model.two_tower, target, n_items)
